...
import urllib2
import sys
access_key = 'oC1gaq00U0YxdIqNyAJ-e0Lkbhgn2ksXHnEvC7XB'
secret_key = '8m5qIDPyQKAY-95IAGtIB3uvvZUhgAyNa3G3DhW7'
bucket_name = 'csinla'
bucket_domain = 'img.csinla.com'
...
ignore_names = [".DS_Store", ".git", ".gitignore",
                "qiniusync.py", "README.md", "LICENSE"]
charset = "utf8"
diff_time = 2 * 60
...
def get_valid_key_files(subdir=""):
    ...
    files = get_files(basedir=basedir, ignore_paths=ignore_paths,
...
def upload_file(key, localfile):
    ...
    ret, info = qiniu.put_file(
        token, key, localfile, params, mime_type, progress_handler=progress_handler)
